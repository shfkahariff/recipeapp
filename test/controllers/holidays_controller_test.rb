...
class HolidaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create holiday" do
    assert_difference("Holiday.count") do
      post holidays_url, params: { holiday: { endholiday: @holiday.endholiday, startholiday: @holiday.startholiday, type: @holiday.type } }
    end
  ...
  test "should update holiday" do
    patch holiday_url(@holiday), params: { holiday: { endholiday: @holiday.endholiday, startholiday: @holiday.startholiday, type: @holiday.type } }
