...
class LeavesTest < ApplicationSystemTestCase
  ...
  test "should create leafe" do
    ...
    fill_in "Attachment", with: @leafe.attachment
    fill_in "Comment", with: @leafe.comment
    fill_in "Duration", with: @leafe.duration
    fill_in "Enddate", with: @leafe.endDate
    fill_in "Name", with: @leafe.name
    fill_in "Notes", with: @leafe.notes
    fill_in "Startdate", with: @leafe.startDate
